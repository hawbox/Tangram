...
class CORE_EXPORT HTMLElement : public Element {
 ...
 public:
  ...
  // >>>>> TANGRAMDEV
  virtual bool IsHTMLNewElement() const { return false; }
  virtual void OnFinishParsingChildren() const { return; }
  virtual void OnAttributeChanged(const std::string name,
