...
namespace OfficePlus
{
	namespace VisioPlus
	{
		...
		STDMETHODIMP CVisioAddin::TangramCommand(IDispatch* RibbonControl)
		{
			if (m_spRibbonUI)
		...
		HRESULT CVisioAddin::CreateTangramCtrl(void* pv, REFIID riid, LPVOID* ppv)
		{
		...
		STDMETHODIMP CVisioAppCtrl::get_Tangram(ITangram** pVal)
		{
			*pVal = g_pTangram;
			return S_OK;
		}
